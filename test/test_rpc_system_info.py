...
class TestRpcSystemInfo(unittest.TestCase):
    """RpcSystemInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RpcSystemInfo:
        """Test RpcSystemInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcSystemInfo`
        """
        model = RpcSystemInfo()
        if include_optional:
            return RpcSystemInfo(
