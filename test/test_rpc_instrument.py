...
class TestRpcInstrument(unittest.TestCase):
    """RpcInstrument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RpcInstrument:
        """Test RpcInstrument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcInstrument`
        """
        model = RpcInstrument()
        if include_optional:
            return RpcInstrument(
