...
class TestAuthRecoverRequest(unittest.TestCase):
    """AuthRecoverRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthRecoverRequest:
        """Test AuthRecoverRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthRecoverRequest`
        """
        model = AuthRecoverRequest()
        if include_optional:
    ...
    def testAuthRecoverRequest(self):
        """Test AuthRecoverRequest"""
