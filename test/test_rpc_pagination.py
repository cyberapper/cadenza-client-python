...
class TestRpcPagination(unittest.TestCase):
    """RpcPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RpcPagination:
        """Test RpcPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcPagination`
        """
        model = RpcPagination()
        if include_optional:
            return RpcPagination(
                offset = 0,
                limit = 50,
                total = 100,
                cursor = '',
