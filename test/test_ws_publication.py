...
class TestWsPublication(unittest.TestCase):
    """WsPublication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsPublication:
        """Test WsPublication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsPublication`
        """
        model = WsPublication()
        if include_optional:
            return WsPublication(
                data = { },
