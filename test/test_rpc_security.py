...
class TestRpcSecurity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RpcSecurity:
        """Test RpcSecurity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcSecurity`
        """
        model = RpcSecurity()
        if include_optional:
            return RpcSecurity(
