...
class TestRpcTradeOrder(unittest.TestCase):
    """RpcTradeOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RpcTradeOrder:
        """Test RpcTradeOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcTradeOrder`
        """
        model = RpcTradeOrder()
        if include_optional:
            return RpcTradeOrder(
                trade_order_id = '',
                client_order_id = '',
