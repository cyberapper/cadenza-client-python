...
class TestWsLeave(unittest.TestCase):
    """WsLeave unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsLeave:
        """Test WsLeave
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsLeave`
        """
        model = WsLeave()
        if include_optional:
            return WsLeave(
