...
class TestWsRefreshPush(unittest.TestCase):
    """WsRefreshPush unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsRefreshPush:
        """Test WsRefreshPush
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsRefreshPush`
        """
        model = WsRefreshPush()
        if include_optional:
            return WsRefreshPush(
                expires = True,
                ttl = 56
            )
        else:
