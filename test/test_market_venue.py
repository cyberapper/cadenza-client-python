...
class TestMarketVenue(unittest.TestCase):
    """MarketVenue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketVenue:
        """Test MarketVenue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketVenue`
        """
        model = MarketVenue()
        if include_optional:
            return MarketVenue(
