...
class TestRpcOhlcv(unittest.TestCase):
    """RpcOhlcv unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RpcOhlcv:
        """Test RpcOhlcv
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcOhlcv`
        """
        model = RpcOhlcv()
        if include_optional:
            return RpcOhlcv(
