...
class TestWsRPCRequest(unittest.TestCase):
    """WsRPCRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsRPCRequest:
        """Test WsRPCRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsRPCRequest`
        """
        model = WsRPCRequest()
        if include_optional:
            return WsRPCRequest(
