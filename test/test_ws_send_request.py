...
class TestWsSendRequest(unittest.TestCase):
    """WsSendRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsSendRequest:
        """Test WsSendRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsSendRequest`
        """
        model = WsSendRequest()
        if include_optional:
            return WsSendRequest(
                data = { }
            )
        else:
            return WsSendRequest(
