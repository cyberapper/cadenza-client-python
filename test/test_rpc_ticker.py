...
class TestRpcTicker(unittest.TestCase):
    """RpcTicker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RpcTicker:
        """Test RpcTicker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RpcTicker`
        """
        model = RpcTicker()
        if include_optional:
            return RpcTicker(
