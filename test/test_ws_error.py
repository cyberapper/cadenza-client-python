...
class TestWsError(unittest.TestCase):
    """WsError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsError:
        """Test WsError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsError`
        """
        model = WsError()
        if include_optional:
            return WsError(
