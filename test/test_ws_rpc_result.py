...
class TestWsRPCResult(unittest.TestCase):
    """WsRPCResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WsRPCResult:
        """Test WsRPCResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WsRPCResult`
        """
        model = WsRPCResult()
        if include_optional:
            return WsRPCResult(
