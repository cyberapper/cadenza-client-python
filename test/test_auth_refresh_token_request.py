...
class TestAuthRefreshTokenRequest(unittest.TestCase):
    """AuthRefreshTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthRefreshTokenRequest:
        """Test AuthRefreshTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthRefreshTokenRequest`
        """
    ...
    def testAuthRefreshTokenRequest(self):
        """Test AuthRefreshTokenRequest"""
