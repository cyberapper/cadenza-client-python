...
json = "{}"
# create an instance of ListMarketTickers200Response from a JSON string
list_market_tickers200_response_instance = ListMarketTickers200Response.from_json(json)
# print the JSON string representation of the object
print(ListMarketTickers200Response.to_json())

# convert the object into a dict
list_market_tickers200_response_dict = list_market_tickers200_response_instance.to_dict()
# create an instance of ListMarketTickers200Response from a dict
list_market_tickers200_response_from_dict = ListMarketTickers200Response.from_dict(list_market_tickers200_response_dict)
```
