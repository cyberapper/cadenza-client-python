...
json = "{}"
# create an instance of GetMarketTicker200Response from a JSON string
get_market_ticker200_response_instance = GetMarketTicker200Response.from_json(json)
# print the JSON string representation of the object
print(GetMarketTicker200Response.to_json())

# convert the object into a dict
get_market_ticker200_response_dict = get_market_ticker200_response_instance.to_dict()
# create an instance of GetMarketTicker200Response from a dict
get_market_ticker200_response_from_dict = GetMarketTicker200Response.from_dict(get_market_ticker200_response_dict)
```
