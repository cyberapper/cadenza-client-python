...
class RpcSaveSecuritiesResponse(BaseModel):
    """
    Response for saving securities
    """ # noqa: E501
    data: Optional[List[RpcSecurity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RpcSecurity.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
