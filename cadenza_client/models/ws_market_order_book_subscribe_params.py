...
class WsMarketOrderBookSubscribeParams(BaseModel):
    """
    WsMarketOrderBookSubscribeParams
    """ # noqa: E501
    venue: Venue
    symbol: StrictStr
    depth: Optional[StrictInt] = 20
    __properties: ClassVar[List[str]] = ["venue", "symbol", "depth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "depth": obj.get("depth") if obj.get("depth") is not None else 20
        })
        return _obj
