...
class FermataListWallets200Response(BaseModel):
    """
    ...
    data: Optional[List[FermataWallet]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [FermataWallet.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
