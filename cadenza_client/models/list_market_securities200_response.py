...
class ListMarketSecurities200Response(BaseModel):
    """
    ...
    data: Optional[List[FinancialSecurity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [FinancialSecurity.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
