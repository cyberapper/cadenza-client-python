...
class CancelTradeOrderCommand(BaseModel):
    """
    CancelTradeOrderCommand
    """ # noqa: E501
    metadata: CommandMetadata
    data: CancelTradeOrderRequest
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CancelTradeOrderRequest.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
