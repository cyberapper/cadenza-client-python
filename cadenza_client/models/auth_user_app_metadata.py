...
class AuthUserAppMetadata(BaseModel):
    """
    Application metadata
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, description="Tenant ID", alias="tenantId")
    environments: Optional[List[StrictStr]] = Field(default=None, description="Allowed environments")
    __properties: ClassVar[List[str]] = ["tenantId", "environments"]
