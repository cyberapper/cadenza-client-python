...
class RpcValidateTradingAccountResult(BaseModel):
    """
    Response for trading account validation
    """ # noqa: E501
    data: Optional[RpcValidateTradingAccountResultData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcValidateTradingAccountResultData.from_dict(obj["data"]) if obj.get("data") is not None else None,
