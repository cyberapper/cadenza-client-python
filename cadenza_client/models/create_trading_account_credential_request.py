...
class CreateTradingAccountCredentialRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["venue", "nickname", "credentialType", "apiKey", "apiSecret", "apiPassphrase"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiPassphrase": obj.get("apiPassphrase")
        })
        return _obj
