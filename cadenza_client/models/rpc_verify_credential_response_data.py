...
class RpcVerifyCredentialResponseData(BaseModel):
    """
    RpcVerifyCredentialResponseData
    """ # noqa: E501
    trading_accounts: Optional[List[RpcTradingAccount]] = Field(default=None, alias="tradingAccounts")
    __properties: ClassVar[List[str]] = ["tradingAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tradingAccounts": [RpcTradingAccount.from_dict(_item) for _item in obj["tradingAccounts"]] if obj.get("tradingAccounts") is not None else None
        })
        return _obj
