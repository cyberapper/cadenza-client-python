...
class RpcSaveKlinesRequest(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in klines (list)
        _items = []
        if self.klines:
            for _item_klines in self.klines:
                if _item_klines:
                    _items.append(_item_klines.to_dict())
            _dict['klines'] = _items
        return _dict
