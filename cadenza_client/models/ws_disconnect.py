...
class WsDisconnect(BaseModel):
    """
    Server-initiated disconnect notification
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Disconnect reason code")
    reason: Optional[StrictStr] = Field(default=None, description="Disconnect reason message")
    reconnect: Optional[StrictBool] = Field(default=None, description="Whether client should attempt to reconnect")
    __properties: ClassVar[List[str]] = ["code", "reason", "reconnect"]
