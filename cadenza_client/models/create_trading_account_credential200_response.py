...
class CreateTradingAccountCredential200Response(BaseModel):
    """
    ...
    data: Optional[TradingAccountCredential] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": TradingAccountCredential.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
