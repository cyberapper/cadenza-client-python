...
class RpcUnsubscribeOrderBookRequest(BaseModel):
    """
    Request to unsubscribe from order book updates
    """ # noqa: E501
    subscription_id: Optional[UUID] = Field(default=None, description="Subscription ID to cancel", alias="subscriptionId")
    instrument_id: Optional[StrictStr] = Field(default=None, description="Instrument ID to unsubscribe", alias="instrumentId")
    __properties: ClassVar[List[str]] = ["subscriptionId", "instrumentId"]
