...
class RpcVerifyCredentialRequest(BaseModel):
    """
    Request to verify credentials
    """ # noqa: E501
    credential_ids: Optional[List[UUID]] = Field(default=None, alias="credentialIds")
    credentials: Optional[List[RpcTradingAccountCredential]] = None
    __properties: ClassVar[List[str]] = ["credentialIds", "credentials"]
