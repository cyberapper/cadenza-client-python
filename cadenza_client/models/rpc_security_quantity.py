...
class RpcSecurityQuantity(BaseModel):
    """
    Asset quantity pair
    """ # noqa: E501
    asset: Optional[StrictStr] = Field(default=None, description="Asset symbol")
    quantity: Optional[StrictStr] = Field(default=None, description="Quantity (decimal string)")
    __properties: ClassVar[List[str]] = ["asset", "quantity"]
