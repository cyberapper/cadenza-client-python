...
class RpcConnectTradingAccountResult(BaseModel):
    """
    Response from connecting a trading account
    """ # noqa: E501
    data: Optional[RpcTradingAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcTradingAccount.from_dict(obj["data"]) if obj.get("data") is not None else None,
