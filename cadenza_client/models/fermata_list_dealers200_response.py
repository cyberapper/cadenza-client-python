...
class FermataListDealers200Response(BaseModel):
    """
    ...
    data: Optional[List[FermataDealer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [FermataDealer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
