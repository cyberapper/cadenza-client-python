...
class CommandMetadata(BaseModel):
    ...
    event_id: UUID = Field(description="Unique command identifier", alias="eventId")
    ...
    __properties: ClassVar[List[str]] = ["traceId", "eventId", "eventType", "timestamp", "sender", "receiver"]
