...
class RpcGetTradeOrderByIdResponse(BaseModel):
    """
    Response for getting trade order by ID
    """ # noqa: E501
    data: Optional[RpcTradeOrder] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcTradeOrder.from_dict(obj["data"]) if obj.get("data") is not None else None,
