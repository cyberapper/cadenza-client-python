...
class AuthUpdateUserRequest(BaseModel):
    ...
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="New email address")
    password: Optional[Annotated[str, Field(min_length=8, strict=True)]] = Field(default=None, description="New password (minimum 8 characters)")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="User metadata to update")
    __properties: ClassVar[List[str]] = ["email", "password", "metadata"]
