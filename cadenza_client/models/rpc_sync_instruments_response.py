...
class RpcSyncInstrumentsResponse(BaseModel):
    """
    Response for instrument sync
    """ # noqa: E501
    data: Optional[RpcSyncInstrumentsResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcSyncInstrumentsResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
