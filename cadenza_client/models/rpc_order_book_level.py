...
class RpcOrderBookLevel(BaseModel):
    """
    Single price level in order book
    """ # noqa: E501
    price: Optional[StrictStr] = Field(default=None, description="Price level")
    quantity: Optional[StrictStr] = Field(default=None, description="Quantity at this price")
    __properties: ClassVar[List[str]] = ["price", "quantity"]
