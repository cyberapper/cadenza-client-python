...
class WsPresenceStatsResult(BaseModel):
    """
    Presence statistics result
    """ # noqa: E501
    num_clients: Optional[StrictInt] = Field(default=None, description="Number of connected clients", alias="numClients")
    num_users: Optional[StrictInt] = Field(default=None, description="Number of unique users", alias="numUsers")
    __properties: ClassVar[List[str]] = ["numClients", "numUsers"]
