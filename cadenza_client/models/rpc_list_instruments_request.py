...
class RpcListInstrumentsRequest(BaseModel):
    """
    Request to list instruments
    """ # noqa: E501
    venue: Optional[Venue] = None
    symbols: Optional[List[StrictStr]] = None
    security_type: Optional[StrictStr] = Field(default=None, alias="securityType")
    instrument_status: Optional[StrictStr] = Field(default=None, alias="instrumentStatus")
    limit: Optional[StrictInt] = None
    offset: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["venue", "symbols", "securityType", "instrumentStatus", "limit", "offset"]
