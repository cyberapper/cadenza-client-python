...
class WsSubRefreshResult(BaseModel):
    """
    Subscription refresh result
    """ # noqa: E501
    expires: Optional[StrictBool] = Field(default=None, description="Whether subscription expires")
    ttl: Optional[StrictInt] = Field(default=None, description="New TTL in seconds")
    __properties: ClassVar[List[str]] = ["expires", "ttl"]
