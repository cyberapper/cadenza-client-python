...
class RpcDisableInstrumentResponse(BaseModel):
    """
    Response for disabling instrument
    """ # noqa: E501
    data: Optional[RpcInstrument] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcInstrument.from_dict(obj["data"]) if obj.get("data") is not None else None,
