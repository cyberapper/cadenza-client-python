...
class ListTradingAccountPortfolios200Response(BaseModel):
    """
    ...
    data: Optional[List[Portfolio]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Portfolio.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
