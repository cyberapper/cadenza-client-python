...
class ListMarketVenues200Response(BaseModel):
    """
    ...
    data: Optional[List[MarketVenue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [MarketVenue.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
