...
class RpcRotateCredentialResponse(BaseModel):
    """
    Response for credential rotation
    """ # noqa: E501
    data: Optional[RpcTradingAccountCredential] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcTradingAccountCredential.from_dict(obj["data"]) if obj.get("data") is not None else None,
