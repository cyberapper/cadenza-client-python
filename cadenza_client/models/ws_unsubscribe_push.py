...
class WsUnsubscribePush(BaseModel):
    """
    Server-initiated unsubscribe notification
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Unsubscribe reason code")
    reason: Optional[StrictStr] = Field(default=None, description="Unsubscribe reason message")
