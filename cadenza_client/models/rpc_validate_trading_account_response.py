...
class RpcValidateTradingAccountResponse(BaseModel):
    """
    Response for trading account validation
    """ # noqa: E501
    data: Optional[RpcValidateTradingAccountResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcValidateTradingAccountResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
