...
class RpcDeleteSecuritiesRequest(BaseModel):
    """
    Request to delete securities
    """ # noqa: E501
    security_ids: List[UUID] = Field(alias="securityIds")
    __properties: ClassVar[List[str]] = ["securityIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "securityIds": obj.get("securityIds")
        })
        return _obj
