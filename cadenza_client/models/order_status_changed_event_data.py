...
class OrderStatusChangedEventData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["order", "previousStatus", "newStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": TradeOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
