...
class RpcListTradingAccountSubscriptionsResponse(BaseModel):
    """
    Response for listing trading account subscriptions
    """ # noqa: E501
    data: Optional[List[RpcSubscription]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RpcSubscription.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
