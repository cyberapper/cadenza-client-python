...
class RpcListTradingAccountOperationsResponse(BaseModel):
    """
    Response for listing trading account operations
    """ # noqa: E501
    data: Optional[List[RpcTradingAccountOperationHistory]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RpcTradingAccountOperationHistory.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
