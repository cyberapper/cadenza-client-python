...
class WsSubscribePush(BaseModel):
    """
    Server-initiated subscribe notification
    """ # noqa: E501
    recoverable: Optional[StrictBool] = None
    epoch: Optional[StrictStr] = None
    offset: Optional[StrictInt] = None
    positioned: Optional[StrictBool] = None
    data: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["recoverable", "epoch", "offset", "positioned", "data"]
