...
class RpcSaveTradingAccountsResponse(BaseModel):
    """
    Response for saving trading accounts
    """ # noqa: E501
    data: Optional[List[RpcTradingAccount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RpcTradingAccount.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
