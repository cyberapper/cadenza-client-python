...
class RpcVerifyCredentialResult(BaseModel):
    """
    Response for credential verification
    """ # noqa: E501
    data: Optional[RpcVerifyCredentialResultData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcVerifyCredentialResultData.from_dict(obj["data"]) if obj.get("data") is not None else None,
