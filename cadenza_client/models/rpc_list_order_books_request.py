...
class RpcListOrderBooksRequest(BaseModel):
    """
    Request to list order books for multiple instruments
    """ # noqa: E501
    instrument_ids: Optional[List[StrictStr]] = Field(default=None, description="List of instrument IDs", alias="instrumentIds")
    venue: Optional[StrictStr] = Field(default=None, description="Filter by venue")
    symbols: Optional[List[StrictStr]] = Field(default=None, description="List of symbols")
    depth: Optional[StrictInt] = Field(default=10, description="Order book depth")
    __properties: ClassVar[List[str]] = ["instrumentIds", "venue", "symbols", "depth"]
