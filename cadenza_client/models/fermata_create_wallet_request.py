...
class FermataCreateWalletRequest(BaseModel):
    """
    Create a new wallet
    """ # noqa: E501
    nickname: Optional[StrictStr] = Field(default=None, description="Nickname for the new wallet")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["nickname"]
