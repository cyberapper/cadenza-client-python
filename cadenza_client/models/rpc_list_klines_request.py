...
class RpcListKlinesRequest(BaseModel):
    """
    Request to list klines
    """ # noqa: E501
    instrument_ids: Optional[List[StrictStr]] = Field(default=None, alias="instrumentIds")
    venue: Optional[Venue] = None
    symbols: Optional[List[StrictStr]] = None
    interval: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["instrumentIds", "venue", "symbols", "interval"]
