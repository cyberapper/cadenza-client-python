...
class RpcUnsubscribeTradingAccountStreamResponse(BaseModel):
    """
    Response for trading account stream unsubscription
    """ # noqa: E501
    data: Optional[RpcSubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcSubscription.from_dict(obj["data"]) if obj.get("data") is not None else None,
