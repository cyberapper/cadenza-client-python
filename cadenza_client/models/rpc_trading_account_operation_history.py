...
class RpcTradingAccountOperationHistory(BaseModel):
    """
    ...
    previous_values: Optional[Dict[str, Any]] = Field(default=None, alias="previousValues")
    new_values: Optional[Dict[str, Any]] = Field(default=None, alias="newValues")
    __properties: ClassVar[List[str]] = ["tradingAccountHistoryId", "tradingAccountId", "timestamp", "operationType", "operateBy", "tags", "previousValues", "newValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tradingAccountHistoryId": obj.get("tradingAccountHistoryId"),
            "tradingAccountId": obj.get("tradingAccountId"),
            "timestamp": obj.get("timestamp"),
            "operationType": obj.get("operationType"),
            "operateBy": obj.get("operateBy"),
            "tags": obj.get("tags"),
            "previousValues": obj.get("previousValues"),
            "newValues": obj.get("newValues")
        })
        return _obj
