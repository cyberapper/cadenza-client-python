...
class RpcVerifyCredentialResponse(BaseModel):
    """
    Response for credential verification
    """ # noqa: E501
    data: Optional[RpcVerifyCredentialResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RpcVerifyCredentialResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
