...
class RpcSaveSecuritiesRequest(BaseModel):
    """
    Request to save securities
    """ # noqa: E501
    securities: List[RpcSecurity]
    __properties: ClassVar[List[str]] = ["securities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.securities:
            for _item_securities in self.securities:
                if _item_securities:
                    _items.append(_item_securities.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "securities": [RpcSecurity.from_dict(_item) for _item in obj["securities"]] if obj.get("securities") is not None else None
        })
        return _obj
