...
class RpcSavePortfolioRequest(BaseModel):
    """
    Request to save a portfolio
    """ # noqa: E501
    portfolio: RpcPortfolio
    __properties: ClassVar[List[str]] = ["portfolio"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "portfolio": RpcPortfolio.from_dict(obj["portfolio"]) if obj.get("portfolio") is not None else None
        })
        return _obj
