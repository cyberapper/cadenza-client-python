...
class WsRefreshResult(BaseModel):
    """
    Refresh result
    """ # noqa: E501
    client: Optional[StrictStr] = Field(default=None, description="Client ID")
    version: Optional[StrictStr] = Field(default=None, description="Server version")
    expires: Optional[StrictBool] = Field(default=None, description="Whether connection expires")
    ttl: Optional[StrictInt] = Field(default=None, description="New TTL in seconds")
    __properties: ClassVar[List[str]] = ["client", "version", "expires", "ttl"]
