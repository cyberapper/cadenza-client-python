...
class WsPublishRequest(BaseModel):
    ...
    """ # noqa: E501
    channel: StrictStr = Field(description="Channel to publish to")
    data: Dict[str, Any] = Field(description="Message data to publish")
    __properties: ClassVar[List[str]] = ["channel", "data"]
