...
class FermataCreateWallet200Response(BaseModel):
    """
    ...
    data: Optional[FermataWallet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FermataWallet.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
