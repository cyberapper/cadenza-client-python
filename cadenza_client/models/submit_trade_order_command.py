...
class SubmitTradeOrderCommand(BaseModel):
    """
    SubmitTradeOrderCommand
    """ # noqa: E501
    metadata: CommandMetadata
    data: SubmitTradeOrderRequest
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SubmitTradeOrderRequest.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
