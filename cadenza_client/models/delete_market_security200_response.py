...
class DeleteMarketSecurity200Response(BaseModel):
    """
    ...
    data: Optional[FinancialSecurity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FinancialSecurity.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
