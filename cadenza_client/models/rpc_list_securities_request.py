...
class RpcListSecuritiesRequest(BaseModel):
    """
    Request to list securities
    """ # noqa: E501
    venue: Optional[Venue] = None
    securities: Optional[List[StrictStr]] = None
    external_symbols: Optional[List[StrictStr]] = Field(default=None, alias="externalSymbols")
    __properties: ClassVar[List[str]] = ["venue", "securities", "externalSymbols"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "externalSymbols": obj.get("externalSymbols")
        })
        return _obj
