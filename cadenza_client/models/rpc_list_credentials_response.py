...
class RpcListCredentialsResponse(BaseModel):
    """
    Response for listing credentials
    """ # noqa: E501
    data: Optional[List[RpcTradingAccountCredential]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RpcTradingAccountCredential.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
