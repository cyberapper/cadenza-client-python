...
class SyncMarketInstrumentsRequest(BaseModel):
    """
    SyncMarketInstrumentsRequest
    """ # noqa: E501
    venue: Venue
    symbols: List[StrictStr] = Field(description="symbol list, example \\[\"BTC/ETH\",\"BTC/USDT\"\\]")
    __properties: ClassVar[List[str]] = ["venue", "symbols"]
