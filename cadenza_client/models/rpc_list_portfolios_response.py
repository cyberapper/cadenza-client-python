...
class RpcListPortfoliosResponse(BaseModel):
    """
    Response containing list of portfolios
    """ # noqa: E501
    data: Optional[List[RpcPortfolio]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RpcPortfolio.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
